...
function deserializeData(compressedData, dictionary) {
...
api.interceptors.response.use(
    response => {
        ...
        if (responseData && responseData.dictionary && responseData.data) {
            const dictionary = responseData.dictionary;
            const decompressedData = deserializeData(responseData.data, dictionary);
