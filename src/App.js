            ...
            <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
                <Router>
                    <Routes>
                        ...
                        <Route path="/register"  element={<RegisterPage  toggleTheme={toggleTheme} currentTheme={theme}/>}/>
                        <Route path="/recovery"  element={<RecoveryPage  toggleTheme={toggleTheme} currentTheme={theme}/>}/>
