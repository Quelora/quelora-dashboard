...
const SystemUserForm = ({ onSuccess, onCancel, availableClients, currentUserRole }) => {
    const { t } = useTranslation();
    ...
    const {
        ...
        handleChange,
        handleSubmit
    } = useSystemUserForm(onSuccess, currentUserRole);
        ...
        <>
            ...
            <DialogActions className="profile-dialog-actions" sx={{ px: 0, mt: 3 }}>
                ...
                <Button 
                    ...
                    variant="contained" 
                    disabled={loading}
                    startIcon={loading ? <RefreshIcon sx={{animation: 'spin 2s linear infinite'}} /> : <AddIcon />}
                >
