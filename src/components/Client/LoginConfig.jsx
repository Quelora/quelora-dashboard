...
const LoginConfig = ({ config, setConfig, isFormSubmitted }) => {
    ...
    const isBaseUrlInvalid = config.config.login.providers?.length > 0 && !config.config.login.baseUrl?.trim();
    const isJwtSecretInvalid = !config.config.login.jwtSecret?.trim();
                                        ...
                                        <Box sx={{ 
                                            ...
                                            <Typography variant="body2">
                                                {t(`client.${provider.toLowerCase()}_instructions`, {
                                                    baseUrl: config.config.login.baseUrl
                                                })}
                                            </Typography>
                                        </Box>
                                    </Box>
