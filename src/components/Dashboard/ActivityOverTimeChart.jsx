// ./src/components/Dashboard/ActivityOverTimeChart.jsx
import { Box, Paper, Typography, Stack, Tooltip } from '@mui/material';
import React from 'react'; // CORRECCIÓN: Importación de React para JSX y Fragment
import {
    AreaChart,
    Area,
    XAxis,
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={chartData} margin={{top: 10, right: 10, left: 0, bottom: 0}}>
                            ...
                            <Area
                                ...
                                fillOpacity={0.1}
                                strokeWidth={2}
                                name={t('dashboard.statistics.likes')}
                            />
                            <Area
                                type="monotone"
                                dataKey="shares"
                                ...
                                fillOpacity={0.1}
                                strokeWidth={2}
                                name={t('dashboard.statistics.shares')}
                            />
                        </AreaChart>
                    </ResponsiveContainer>
                </Box>
