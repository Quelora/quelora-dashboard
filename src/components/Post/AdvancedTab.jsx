...
const AdvancedTab = ({ formData, handleChange, handleNumberChange, validationErrors, isGeneralConfig, t }) => {
    return (
            ...
            <Box className="moderation-section">
                ...
                {formData.config.moderation.enable_content_moderation && (
                    <TextField 
                        ...
                        helperText={validationErrors.moderation_prompt ? t('postForm.moderationPromptRequired') : t('postForm.moderationPromptHelper')}
                    />
                )}
